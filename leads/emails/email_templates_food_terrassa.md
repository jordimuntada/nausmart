# Plantillas de Email - Empresas Alimentación y Nuevas (Terrassa/Vallès)

> Campaña de cold email para leads nuevos del CSV `leads_food_companies_Terrassa.csv`.
> Enfoque: empresas de alimentación con sede o actividad en Terrassa/Vallès + nuevos leads no cubiertos en la campaña anterior.
...
## Sin email de contacto (LinkedIn solamente)
